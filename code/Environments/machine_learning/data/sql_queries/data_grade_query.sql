...
assessments.total_assessment_score_percent, grade.gpa
FROM student, enrolment, attendance, interaction, topics, grade, assessments
WHERE student.student_id = enrolment.student_id 
AND enrolment.enrolment_id = assessments.enrolment_id
